...
/**
 * @title MultiSigManager - Intermediate Level Algorithm Library
 ...
 * @notice Intermediate Level - Library #49
 */

library MultiSigManager {
    // Error definitions
    error MathOverflow();
    error InvalidInput();
    ...
    function advancedCalculation(
        ...
        require(input > 0, "MultiSigManager: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "MultiSigManager: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "MultiSigManager: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "MultiSigManager: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "MultiSigManager: empty data set");
