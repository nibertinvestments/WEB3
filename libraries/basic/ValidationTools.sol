...
/**
 * @title ValidationTools - Basic Level Algorithm Library
 ...
 * @notice Basic Level - Library #44
 */

library ValidationTools {
    // Error definitions
    error MathOverflow();
    error InvalidInput();
    ...
    function advancedCalculation(
        ...
        require(input > 0, "ValidationTools: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "ValidationTools: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "ValidationTools: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "ValidationTools: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "ValidationTools: empty data set");
