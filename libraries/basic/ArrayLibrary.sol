...
/**
 * @title ArrayLibrary - Basic Level Algorithm Library
...
library ArrayLibrary {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "ArrayLibrary: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "ArrayLibrary: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "ArrayLibrary: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "ArrayLibrary: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "ArrayLibrary: empty data set");
