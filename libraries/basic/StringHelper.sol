...
/**
 * @title StringHelper - Basic Level Algorithm Library
...
library StringHelper {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "StringHelper: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "StringHelper: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "StringHelper: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "StringHelper: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "StringHelper: empty data set");
