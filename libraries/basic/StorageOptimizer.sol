...
/**
 * @title StorageOptimizer - Basic Level Algorithm Library
...
library StorageOptimizer {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "StorageOptimizer: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "StorageOptimizer: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "StorageOptimizer: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "StorageOptimizer: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "StorageOptimizer: empty data set");
