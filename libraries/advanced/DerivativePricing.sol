...
/**
 * @title DerivativePricing - Advanced Level Algorithm Library
 ...
 * @notice Advanced Level - Library #42
 */
...
library DerivativePricing {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "DerivativePricing: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "DerivativePricing: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "DerivativePricing: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "DerivativePricing: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "DerivativePricing: empty data set");
