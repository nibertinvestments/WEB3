...
/**
 * @title LiquidationManager - Advanced Level Algorithm Library
 ...
 * @notice Advanced Level - Library #50
 */
...
library LiquidationManager {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "LiquidationManager: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "LiquidationManager: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "LiquidationManager: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "LiquidationManager: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "LiquidationManager: empty data set");
