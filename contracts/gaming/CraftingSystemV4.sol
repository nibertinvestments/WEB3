...
/**
 * @title CraftingSystemV4 - Advanced Gaming Implementation
 ...
 * @notice Production-ready gaming contract #39
 */

contract CraftingSystemV4 {
    // Error definitions
    error Unauthorized();
    error InvalidInput();
    ...
    // Modifiers
    modifier onlyOwner() {
        require(msg.sender == owner, "CraftingSystemV4: not owner");
        _;
    }
    
    modifier onlyAuthorized() {
        require(authorized[msg.sender] || msg.sender == owner, "CraftingSystemV4: not authorized");
        _;
    }
    
    modifier notPaused() {
        require(!isPaused, "CraftingSystemV4: contract paused");
        _;
    }
    ...
    function executeAdvancedOperation(
        ...
        require(inputValue > 0, "CraftingSystemV4: invalid input");
        require(algorithmType <= 10, "CraftingSystemV4: invalid algorithm");
    ...
    function updateAdvancedState(
        ...
        require(values.length >= 5, "CraftingSystemV4: insufficient values");
