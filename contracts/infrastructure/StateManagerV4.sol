...
/**
 * @title StateManagerV4 - Advanced Infrastructure Implementation
 ...
 * @notice Production-ready infrastructure contract #39
 */

contract StateManagerV4 {
    // Error definitions
    error Unauthorized();
    error InvalidInput();
    ...
    // Modifiers
    modifier onlyOwner() {
        require(msg.sender == owner, "StateManagerV4: not owner");
        _;
    }
    
    modifier onlyAuthorized() {
        require(authorized[msg.sender] || msg.sender == owner, "StateManagerV4: not authorized");
        _;
    }
    
    modifier notPaused() {
        require(!isPaused, "StateManagerV4: contract paused");
        _;
    }
    ...
    function executeAdvancedOperation(
        ...
        require(inputValue > 0, "StateManagerV4: invalid input");
        require(algorithmType <= 10, "StateManagerV4: invalid algorithm");
    ...
    function updateAdvancedState(
        ...
        require(values.length >= 5, "StateManagerV4: insufficient values");
