...
/**
 * @title AccessManagerV4 - Advanced Infrastructure Implementation
 ...
 * @notice Production-ready infrastructure contract #37
 */

contract AccessManagerV4 {
    // Error definitions
    error Unauthorized();
    error InvalidInput();
    ...
    // Modifiers
    modifier onlyOwner() {
        require(msg.sender == owner, "AccessManagerV4: not owner");
        _;
    }
    
    modifier onlyAuthorized() {
        require(authorized[msg.sender] || msg.sender == owner, "AccessManagerV4: not authorized");
        _;
    }
    
    modifier notPaused() {
        require(!isPaused, "AccessManagerV4: contract paused");
        _;
    }
    ...
    function executeAdvancedOperation(
        ...
        require(inputValue > 0, "AccessManagerV4: invalid input");
        require(algorithmType <= 10, "AccessManagerV4: invalid algorithm");
    ...
    function updateAdvancedState(
        ...
        require(values.length >= 5, "AccessManagerV4: insufficient values");
