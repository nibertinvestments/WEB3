...
/**
 * @title UpgradeControllerV4 - Advanced Infrastructure Implementation
 ...
 * @notice Production-ready infrastructure contract #36
 */

contract UpgradeControllerV4 {
    // Error definitions
    error Unauthorized();
    error InvalidInput();
    ...
    // Modifiers
    modifier onlyOwner() {
        require(msg.sender == owner, "UpgradeControllerV4: not owner");
        _;
    }
    
    modifier onlyAuthorized() {
        require(authorized[msg.sender] || msg.sender == owner, "UpgradeControllerV4: not authorized");
        _;
    }
    
    modifier notPaused() {
        require(!isPaused, "UpgradeControllerV4: contract paused");
        _;
    }
    ...
    function executeAdvancedOperation(
        ...
        require(inputValue > 0, "UpgradeControllerV4: invalid input");
        require(algorithmType <= 10, "UpgradeControllerV4: invalid algorithm");
    ...
    function updateAdvancedState(
        ...
        require(values.length >= 5, "UpgradeControllerV4: insufficient values");
