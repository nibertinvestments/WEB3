...
/**
 * @title UpgradeControllerV2 - Advanced Infrastructure Implementation
 ...
 * @notice Production-ready infrastructure contract #16
 */

contract UpgradeControllerV2 {
    // Error definitions
    error Unauthorized();
    error InvalidInput();
    ...
    // Modifiers
    modifier onlyOwner() {
        require(msg.sender == owner, "UpgradeControllerV2: not owner");
        _;
    }
    
    modifier onlyAuthorized() {
        require(authorized[msg.sender] || msg.sender == owner, "UpgradeControllerV2: not authorized");
        _;
    }
    
    modifier notPaused() {
        require(!isPaused, "UpgradeControllerV2: contract paused");
        _;
    }
    ...
    function executeAdvancedOperation(
        ...
        require(inputValue > 0, "UpgradeControllerV2: invalid input");
        require(algorithmType <= 10, "UpgradeControllerV2: invalid algorithm");
    ...
    function updateAdvancedState(
        ...
        require(values.length >= 5, "UpgradeControllerV2: insufficient values");
