...
/**
 * @title MathUtils - Basic Level Algorithm Library
...
library MathUtils {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "MathUtils: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "MathUtils: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "MathUtils: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "MathUtils: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "MathUtils: empty data set");
