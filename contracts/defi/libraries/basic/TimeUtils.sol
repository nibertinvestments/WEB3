...
library TimeUtils {
    ...
    function addDays(uint256 timestamp, uint256 numDays) 
        ...
        return timestamp + (numDays * SECONDS_PER_DAY);
    }
     ...
     */
    function addWeeks(uint256 timestamp, uint256 numWeeks) 
        internal pure returns (uint256) {
        return timestamp + (numWeeks * SECONDS_PER_WEEK);
    }
    ...
    function addMonths(uint256 timestamp, uint256 numMonths) 
        internal pure returns (uint256) {
        return timestamp + (numMonths * SECONDS_PER_MONTH);
    }
    ...
    function addYears(uint256 timestamp, uint256 numYears) 
        internal pure returns (uint256) {
        return timestamp + (numYears * SECONDS_PER_YEAR);
    }
