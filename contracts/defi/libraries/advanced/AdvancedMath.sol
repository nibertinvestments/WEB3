...
/**
 * @title AdvancedMath - Advanced Level Algorithm Library
 ...
 * @notice Advanced Level - Library #41
 */
...
library AdvancedMath {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "AdvancedMath: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "AdvancedMath: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "AdvancedMath: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "AdvancedMath: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "AdvancedMath: empty data set");
