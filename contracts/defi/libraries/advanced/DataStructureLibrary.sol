...
/**
 * @title DataStructureLibrary - Advanced Level Algorithm Library
 ...
 * @notice Advanced Level - Library #45
 */

library DataStructureLibrary {
    // Error definitions
    error MathOverflow();
    error InvalidInput();
    ...
    function advancedCalculation(
        ...
        require(input > 0, "DataStructureLibrary: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "DataStructureLibrary: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "DataStructureLibrary: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "DataStructureLibrary: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "DataStructureLibrary: empty data set");
