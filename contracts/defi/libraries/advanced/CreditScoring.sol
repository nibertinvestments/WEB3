...
/**
 * @title CreditScoring - Advanced Level Algorithm Library
 ...
 * @notice Advanced Level - Library #47
 */
...
library CreditScoring {
    ...
    function advancedCalculation(
        ...
        require(input > 0, "CreditScoring: invalid input");
    ...
    function rootCalculation(uint256 value, uint256 root) internal pure returns (uint256) {
        require(root > 0, "CreditScoring: invalid root");
        if (value == 0) return 0;
    ...
    function matrixMultiply(
        ...
        require(a.cols == b.rows, "CreditScoring: incompatible matrices");
    ...
    function vectorDotProduct(
        ...
        require(a.length == b.length, "CreditScoring: vector length mismatch");
    ...
    function statisticalAnalysis(
        ...
        require(data.length > 0, "CreditScoring: empty data set");
